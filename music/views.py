...
def post_facebook(request):
    return redirect("https://www.facebook.com/v13.0/dialog/oauth?client_id=" + os.getenv('fb_client_id') + "&redirect_uri=https%3A%2F%2Fstately-granita-d9d023.netlify.app%2F%23%2Fsocial-post%2F&state={\"{st=state123abc,ds=123456789}\"})")
